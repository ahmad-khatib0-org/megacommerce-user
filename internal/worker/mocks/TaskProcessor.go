...
// ProcessSendPasswordResetEmail provides a mock function for the type MockTaskProcessor
func (_mock *MockTaskProcessor) ProcessSendPasswordResetEmail(ctx context.Context, task *asynq.Task) error {
	ret := _mock.Called(ctx, task)

	if len(ret) == 0 {
		panic("no return value specified for ProcessSendPasswordResetEmail")
	}
...
// MockTaskProcessor_ProcessSendPasswordResetEmail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ProcessSendPasswordResetEmail'
type MockTaskProcessor_ProcessSendPasswordResetEmail_Call struct {
	*mock.Call
}

// ProcessSendPasswordResetEmail is a helper method to define mock.On call
//   - ctx context.Context
//   - task *asynq.Task
func (_e *MockTaskProcessor_Expecter) ProcessSendPasswordResetEmail(ctx interface{}, task interface{}) *MockTaskProcessor_ProcessSendPasswordResetEmail_Call {
	return &MockTaskProcessor_ProcessSendPasswordResetEmail_Call{Call: _e.mock.On("ProcessSendPasswordResetEmail", ctx, task)}
}

func (_c *MockTaskProcessor_ProcessSendPasswordResetEmail_Call) Run(run func(ctx context.Context, task *asynq.Task)) *MockTaskProcessor_ProcessSendPasswordResetEmail_Call {
...
func (_c *MockTaskProcessor_ProcessSendPasswordResetEmail_Call) Return(err error) *MockTaskProcessor_ProcessSendPasswordResetEmail_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockTaskProcessor_ProcessSendPasswordResetEmail_Call) RunAndReturn(run func(ctx context.Context, task *asynq.Task) error) *MockTaskProcessor_ProcessSendPasswordResetEmail_Call {
	_c.Call.Return(run)
	return _c
}
