...
func (atp *AsynqTaksDistributor) SendVerifyEmail(context context.Context, payload *intModels.TaskSendVerifyEmailPayload, opts ...asynq.Option) *models.AppError {
	...
	task := asynq.NewTask(string(intModels.TaskNameSendVerifyEmail), pay, opts...)
...
func (atp *AsynqTaksProcessor) ProcessSendVerifyEmail(context context.Context, task *asynq.Task) error {
	path := "user.worker.ProcessSendVerifyEmail"
	var pay intModels.TaskSendVerifyEmailPayload
